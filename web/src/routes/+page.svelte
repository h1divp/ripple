<script lang="ts">
  ...
  import { messages, isConnected, connect, sendMessage, userDisplayName, userId } from '$lib/stores/chat';
...
>
  <ChatHeader isConnected={isConnected} nearbyCounter={nearbyCounter} />
