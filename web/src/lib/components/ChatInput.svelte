...
<div class="mt-4 flex gap-2">
  ...
  rows="1"
  class="textarea textarea-bordered box-border flex-1 resize-none overflow-hidden rounded-lg border-gray-300 py-[9px] leading-5 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-gray-500 disabled:cursor-not-allowed disabled:bg-gray-100"
