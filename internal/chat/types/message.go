...
// Username and AvatarURL fields to be generated by the API and not the client
// They are appended to messages before being distributed
// TODO: generate AvatarURL & username when the userID is generated, store in Client struct
